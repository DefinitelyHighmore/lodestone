...
execute if score #bool lode.id matches 1 run summon text_display ~ ~ ~ {UUID:[I;-244878091,-651148361,-1720295096,-258107165]}
...
data modify storage lode:internal root.hud prepend value '{"text":""}'
execute if score #coords lode.id matches 1 run function lode:zprivate/bossbar/resolve1
execute unless score #coords lode.id matches 1 run function lode:zprivate/bossbar/resolve
