...
data modify storage gu:main in set from storage lode:api marker.uuid
...
function lode:zprivate/bossbar/marker/gu/zzz/get_hexes with storage gu:temp
function lode:zprivate/bossbar/marker/gu/zzz/concat_uuid with storage gu:temp
data modify storage lode:api marker.string_uuid set from storage gu:main out
data modify storage lode:api marker.type set value entity
data modify storage lode:api marker.x set value 0
data modify storage lode:api marker.z set value 0
